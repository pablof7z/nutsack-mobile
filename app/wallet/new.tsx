...
import { Button, View, Text, useThemeColor } from '@/components/Themed';
import { FlashList } from '@shopify/flash-list';
import { useNDK, useSubscribe } from "@/ndk-expo";
import { NDKCashuMintList, NDKEvent, NDKKind, NDKList, NDKPrivateKeySigner } from '@nostr-dev-kit/ndk';
import MintListItem from '@/components/mint/MintListItem';
...
const NewWalletPage = () => {
    ...
    const { events: mintList } = useSubscribe({ filters: [{ kinds: [38172], limit: 50 }] });
